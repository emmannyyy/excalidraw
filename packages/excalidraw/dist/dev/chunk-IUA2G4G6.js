...
var APP_STATE_STORAGE_CONF = /* @__PURE__ */ ((config) => config)({
  ...
  openFortifyStylesPanel: { browser: false, export: false, server: false },
  ...
  switch (element.type) {
    ...
    case "image": {
      ...
      if (fileData) {
        ...
        if (renderConfig.theme === THEME4.DARK && fileData.mimeType === MIME_TYPES4.svg) {
